...
| fudge:design | Orchestrates a UI draft into settled project design documents, gives implementation agents design guidance, or builds requested UI components. | "design this flow", "guide this UI build", or "build these components" |
