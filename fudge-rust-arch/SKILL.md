...
| `[lints]`/Clippy config, banning `unwrap`/`expect`, `clippy.toml`, rustfmt, cargo-nextest, cargo-deny, typos, lefthook hooks, CI workflows, input validation, `unsafe` | `references/quality-and-security.md`  |
