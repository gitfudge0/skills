...
Reference spec for the HTML renderer in the `gf-layered-review` skill. Authoritative — the bundled `example-review.html` is a working implementation of exactly this spec, safe to copy and edit directly.
